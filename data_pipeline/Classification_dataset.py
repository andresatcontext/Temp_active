...
class ClassificationDataset:
    def __init__(self,
        ...
        # read the header from the dataset
        self.dataset_header = dataset.get_dataset_header()
        ...
        # get the filenames from each class
        ...
        # generate the list of files, labels and classes
